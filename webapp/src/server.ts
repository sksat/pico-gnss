...
function startProbeRs(args: Args): void {
  ...
  const onLine = (line: string) => {
    if (logStream && (line.includes("NMEA ") || line.includes("PPS count=") || line.includes("SYNC ") || line.includes("TIME ") || line.includes("PPSOUT ") || line.includes("PPSGEN ") || line.includes("FW "))) {
