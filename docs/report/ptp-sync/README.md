...
これを分けるには、**GP6 を別の state machine で捕捉して、1PPS の捕捉と同じカウンタ上で比べる**
のが筋が良い。PIO0 の 4 本は埋まっているので、PIO1 の空き 2 本に受信機の 1PPS と GP6 を置き、
その 2 本を PIO1 の中で `start_in_sync` することになる。
そこまでやって初めて、チップの中の項とパッドから先の項が分かれる。
