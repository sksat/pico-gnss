...
| | 直す前 | 直したあと |
|---|---:|---:|
| server GP6 − 受信機の秒 | −69 / −79 / −84 / −102 ns | **+4.7 / −1.2 / +12.6 / +10.3 ns** (sd 34 〜 58) |
| client GP6 − server GP6 | +338 / +356 / +411 / +513 ns | **+9.8 / +74.3 / +91.6 ns** (sd 57 〜 135) |
| 報告される経路遅延 | −165.5 ns | **+4.0 ns** (sd 4.7) |

**どちらも 2 桁 ns に入った。**

ただし、3 つのうち最後のもの (折り返しの周波数項) について、**この表は決め手ではない**。
既定の折り返しでの予測は 169 ns だが、補正前の 3 run が +86.0 / +113.2 / +113.3、補正後の 3 run が
+9.8 / +74.3 / +91.6 で、差は 46 ns しかない。
run をまたぐ offset のさまよいが同じ 80 ns 程度あるので、この比較では区別がつかない。
