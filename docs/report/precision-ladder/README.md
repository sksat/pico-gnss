...
![まず 3 本目を足して見張る実験。上: 3 本のカウンタと各自が見るピン。c2 は校正のとき一瞬 GP2 へ切り替わる (これが「校正での切り替え」)。下: c3 は c0 と同じ GP2 を見て切り替わらないので、c0 − c3 には波形の違いも切り替えも効かず、残るのは個体差だけ。c0 − c2 は 3 つ全部が混ざる](precision-figs/fig-kexp-setup.png)
