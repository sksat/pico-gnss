...
ここまでで、同じ GPS-R の 1PPS に対して中心を安定させられること、カウンタのズレのスリップの機構を突き止めてピンの上の中心を +9 ns 前後まで寄せられたこと、残った実ドリフトの出どころ (カウンタの一周のコスト差) を突き止めて直したこと、温度の速い外乱には clamp が効くことまでは確認できた。残っている宿題もいくつかある。
