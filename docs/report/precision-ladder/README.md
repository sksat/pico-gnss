...
![定期校正なし/あり × 修正前/後 の 4 条件。ピンの上のずれから内部の loopback 位相を引き、両方に乗る遅いふらつきを消して中心を見る。左: 定期校正なしは修正の有無によらず約 +4〜5 ns/min でずれていく。右: 定期校正ありは平坦で、修正で中心が +40 ns から +10 ns へ下がる](precision-figs/fig-fix-result.png)
